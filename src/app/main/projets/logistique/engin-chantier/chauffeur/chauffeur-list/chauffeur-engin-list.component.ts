...
@Component({
  selector: 'app-chauffeur-engin-list',
  templateUrl: './chauffeur-engin-list.component.html',
  styleUrls: ['./chauffeur-engin-list.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ChauffeurEnginListComponent implements OnInit {
