...
import {ChauffeurVhListComponent} from './chauffeur-list/chauffeur-vh-list.component';


const routes: Routes = [
    {path: 'chauffeur-list', component: ChauffeurVhListComponent},
