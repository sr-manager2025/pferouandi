...
var RangeTouch = function () {
  ...
  return _createClass(e, [{
    ...
    key: "get", value: function (t) {
      ...
      var i, s = t.target, n = t.changedTouches[0], r = parseFloat(s.getAttribute("min")) || 0,
        a = parseFloat(s.getAttribute("max")) || 100, o = parseFloat(s.getAttribute("step")) || 1,
        l = s.getBoundingClientRect(), c = 100 / l.width * (this.config.thumbWidth / 2) / 100;
...
function getAttributesFromSelector(e, t) {
  ...
  return e.split(",").forEach((e => {
    const t = e.trim(), n = t.replace(".", ""), r = t.replace(/[[\]]/g, "").split("="), [a] = r,
...
function toggleListener(e, t, i, s = !1, n = !0, r = !1) {
  ...
  const a = t.split(" ");
  let o = r;
  supportsPassiveListeners && (o = {passive: n, capture: r}), a.forEach((t => {
...
function loadSprite(e, t) {
  ...
  const i = is.string(t);
  let s = !1;
  const n = () => null !== document.getElementById(t), r = (e, t) => {
    e.innerHTML = t, i && n() || document.body.insertAdjacentElement("afterbegin", e)
  };
  if (!i || !n()) {
    const n = Storage.supported, a = document.createElement("div");
    ...
    fetch(e).then((e => {
      is.empty(e) || (n && window.localStorage.setItem(`cache-${t}`, JSON.stringify({content: e})), r(a, e))
    })).catch((() => {
    }))
  }
}
...
const controls = {
  getIconUrl() {
    ...
    const i = "http://www.w3.org/2000/svg", s = controls.getIconUrl.call(this),
    ...
    })), "button" !== n.element || Object.keys(i).includes("type") || (i.type = "button"), Object.keys(i).includes("class") ? i.class.split(" ").some((e => e === this.config.classNames.control)) || extend(i, {class: `${i.class} ${this.config.classNames.control}`}) : i.class = this.config.classNames.control, e) {
      case"play":
    ...
    if ("volume" !== e) {
      ...
      const t = {played: "played", buffer: "buffered"}[e], s = t ? i18n.get(t, this.config) : "";
    ...
    const e = "captions", t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
      i = captions.getTracks.call(this), s = Boolean(i.length);
    ...
    return dedupe(is.array(this.config.controls) ? this.config.controls : []).forEach((a => {
      ...
      if ("current-time" === a && c.appendChild(r.call(this, "currentTime", u)), "duration" === a && c.appendChild(r.call(this, "duration", u)), "mute" === a || "volume" === a) {
        ...
        if (is.element(t) && c.contains(t) || (t = createElement("div", extend({}, u, {class: `${u.class} plyr__volume`.trim()})), this.elements.volume = t, c.appendChild(t)), "mute" === a && t.appendChild(i.call(this, "mute")), "volume" === a && !browser.isIos) {
          const i = {max: 1, step: .05, value: this.config.volume};
          t.appendChild(n.call(this, "volume", extend(i, {id: `plyr-volume-${e.id}`})))
        }
      }
      if ("captions" === a && c.appendChild(i.call(this, "captions", u)), "settings" === a && !is.empty(this.config.settings)) {
        const s = createElement("div", extend({}, u, {class: `${u.class} plyr__menu`.trim(), hidden: ""}));
        s.appendChild(i.call(this, "settings", {
          "aria-haspopup": !0,
          "aria-controls": `plyr-settings-${e.id}`,
          "aria-expanded": !1
        }));
        const n = createElement("div", {class: "plyr__menu__container", id: `plyr-settings-${e.id}`, hidden: ""}),
          r = createElement("div"), a = createElement("div", {id: `plyr-settings-${e.id}-home`}),
          o = createElement("div", {role: "menu"});
        a.appendChild(o), r.appendChild(a), this.elements.settings.panels.home = a, this.config.settings.forEach((i => {
          ...
          const n = createElement("span", null, i18n.get(i, this.config)),
            a = createElement("span", {class: this.config.classNames.menu.value});
          ...
          u.appendChild(createElement("span", {"aria-hidden": !0}, i18n.get(i, this.config))), u.appendChild(createElement("span", {class: this.config.classNames.hidden}, i18n.get("menuBack", this.config))), on.call(this, c, "keydown", (e => {
            ...
            l.call(this, "home", !1)
          })), c.appendChild(u), c.appendChild(createElement("div", {role: "menu"})), r.appendChild(c), this.elements.settings.buttons[i] = s, this.elements.settings.panels[i] = c
...
const captions = {
    setup() {
      ...
      const e = captions.getTracks.call(this, !0), {active: t, language: i, meta: s, currentTrackNode: n} = this.captions,
        r = Boolean(e.find((e => e.language === i)));
      this.isHTML5 && this.isVideo && e.filter((e => !s.get(e))).forEach((e => {
        this.debug.log("Track added", e), s.set(e, {default: "showing" === e.mode}), "showing" === e.mode && (e.mode = "hidden"), on.call(this, e, "cuechange", (() => captions.updateCues.call(this)))
      ...
      const i = captions.getTracks.call(this), s = e => Number((this.captions.meta.get(e) || {}).default),
  ...
  constructor(e) {
    _defineProperty$1(this, "onChange", (() => {
      ...
      const t = document.activeElement,
        i = getElements.call(this.player, "a[href], button:not(:disabled), input:not(:disabled), [tabindex]"), [s] = i,
        n = i[i.length - 1];
  ...
  constructor(e) {
    _defineProperty$1(this, "firstTouch", (() => {
      ...
      const n = () => {
        ...
        const t = i.wrapper, {active: s} = e.fullscreen, [n, r] = getAspectRatio.call(e),
      ...
      if (t.buttons.play && Array.from(t.buttons.play).forEach((t => {
        ...
        const r = i.hasAttribute(n), a = ["mouseup", "touchend", "keyup"].includes(t.type);
...
var loadjs_umd = createCommonjsModule((function (e, t) {
  e.exports = function () {
    ...
    function o(t, i, s, n) {
      var r, a, l = document, c = s.async, u = (s.numRetries || 0) + 1, d = s.before || e,
        h = t.replace(/[\?|#].*$/, ""), m = t.replace(/^(css|img)!/, "");
    ...
    function l(e, t, i) {
      var s, n, r = (e = e.push ? e : [e]).length, a = r, l = [];
...
const vimeo = {
  setup() {
    ...
    const r = buildUrlParams({
      ...
      muted: e.muted,
      gesture: "media",
      playsinline: !this.config.fullscreen.iosNative, ...n
    });
    let a = e.media.getAttribute("src");
    is.empty(a) && (a = e.media.getAttribute(e.config.attributes.embed.id));
    const o = parseId$1(a), l = createElement("iframe"), c = format(e.config.urls.vimeo.iframe, o, r);
    ...
    Object.defineProperty(e.media, "loop", {
      ...
      this.debug.warn(e)
    })), Object.defineProperty(e.media, "currentSrc", {get: () => p}), Object.defineProperty(e.media, "ended", {get: () => e.currentTime === e.duration}), Promise.all([e.embed.getVideoWidth(), e.embed.getVideoHeight()]).then((t => {
      const [i, s] = t;
      ...
      events: {
        onError(t) {
          if (!e.media.error) {
            ...
            e.media.error = {code: i, message: s}, triggerEvent.call(e, e.media, "error")
          }
        ...
        if (0 !== e && -1 !== e && e < this.player.duration) {
          ...
          if (is.element(t)) {
            const i = 100 / this.player.duration * e,
              s = createElement("span", {class: this.player.config.classNames.cues});
...
class PreviewThumbnails {
  constructor(e) {
    _defineProperty$1(this, "load", (() => {
      ...
      const t = this.showingThumb, i = this.thumbnails[e], {urlPrefix: s} = i, n = i.frames[t], r = i.frames[t].text,
        a = s + r;
...
const source = {
  insertElements(e, t) {
    ...
    getDeep(e, "sources.length") ? (html5.cancelRequests.call(this), this.destroy.call(this, (() => {
      ...
      const {sources: t, type: i} = e, [{provider: s = providers.html5, src: n}] = t, r = "html5" === s ? i : "div",
        a = "html5" === s ? {} : {src: n};
      Object.assign(this, {
        provider: s,
        type: i,
...
class Plyr {
  ...
  set quality(e) {
    ...
    if (!i.length) return;
    let s = [!is.empty(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(is.number), n = !0;
    if (!i.includes(s)) {
      const e = closest(i, s);
