...
var check = function (e) {
  ...
  global_1 = check("object" == typeof globalThis && globalThis) || check("object" == typeof window && window) || check("object" == typeof self && self) || check("object" == typeof commonjsGlobal && commonjsGlobal) || function () {
    return this
  }() || Function("return this")(), fails = function (e) {
    try {
      return !!e()
    } catch (e) {
      return !0
  ...
  })), $propertyIsEnumerable = {}.propertyIsEnumerable, getOwnPropertyDescriptor$1 = Object.getOwnPropertyDescriptor,
  NASHORN_BUG = getOwnPropertyDescriptor$1 && !$propertyIsEnumerable.call({1: 2}, 1), f$4 = NASHORN_BUG ? function (e) {
    var t = getOwnPropertyDescriptor$1(this, e);
    return !!t && t.enumerable
  } : $propertyIsEnumerable, objectPropertyIsEnumerable = {f: f$4}, createPropertyDescriptor = function (e, t) {
    return {enumerable: !(1 & e), configurable: !(2 & e), writable: !(4 & e), value: t}
  }, toString = {}.toString, classofRaw = function (e) {
    return toString.call(e).slice(8, -1)
  }, split = "".split, indexedObject = fails((function () {
    return !Object("z").propertyIsEnumerable(0)
  })) ? function (e) {
    return "String" == classofRaw(e) ? split.call(e, "") : Object(e)
  } : Object, requireObjectCoercible = function (e) {
    ...
    var i, n;
    if (t && "function" == typeof (i = e.toString) && !isObject$2(n = i.call(e))) return n;
    if ("function" == typeof (i = e.valueOf) && !isObject$2(n = i.call(e))) return n;
    if (!t && "function" == typeof (i = e.toString) && !isObject$2(n = i.call(e))) return n;
    throw TypeError("Can't convert object to primitive value")
  }, hasOwnProperty = {}.hasOwnProperty, has$1 = function (e, t) {
    return hasOwnProperty.call(e, t)
  }, document$1 = global_1.document, EXISTS = isObject$2(document$1) && isObject$2(document$1.createElement),
  ...
  f$3 = descriptors ? $getOwnPropertyDescriptor : function (e, t) {
    if (e = toIndexedObject(e), t = toPrimitive(t, !0), ie8DomDefine) try {
      return $getOwnPropertyDescriptor(e, t)
    } catch (e) {
    }
    if (has$1(e, t)) return createPropertyDescriptor(!objectPropertyIsEnumerable.f.call(e, t), e[t])
  }, objectGetOwnPropertyDescriptor = {f: f$3}, anObject = function (e) {
    if (!isObject$2(e)) throw TypeError(String(e) + " is not an object");
    return e
  }, $defineProperty = Object.defineProperty, f$2 = descriptors ? $defineProperty : function (e, t, i) {
    if (anObject(e), t = toPrimitive(t, !0), anObject(i), ie8DomDefine) try {
      return $defineProperty(e, t, i)
    } catch (e) {
    }
    if ("get" in i || "set" in i) throw TypeError("Accessors not supported");
    return "value" in i && (e[t] = i.value), e
  }, objectDefineProperty = {f: f$2}, createNonEnumerableProperty = descriptors ? function (e, t, i) {
    return objectDefineProperty.f(e, t, createPropertyDescriptor(1, i))
  } : function (e, t, i) {
    return e[t] = i, e
...
var set, get, has, inspectSource = sharedStore.inspectSource, WeakMap$2 = global_1.WeakMap,
  nativeWeakMap = "function" == typeof WeakMap$2 && /native code/.test(inspectSource(WeakMap$2)), isPure = !1,
  ...
  }, keys = shared("keys"), sharedKey = function (e) {
    return keys[e] || (keys[e] = uid(e))
  }, hiddenKeys$1 = {}, WeakMap$1 = global_1.WeakMap, enforce = function (e) {
    return has(e) ? get(e) : set(e, {})
  }, getterFor = function (e) {
    return function (t) {
      var i;
      if (!isObject$2(t) || (i = get(t)).type !== e) throw TypeError("Incompatible receiver, " + e + " required");
      return i
    }
  };
if (nativeWeakMap) {
  var store = sharedStore.state || (sharedStore.state = new WeakMap$1), wmget = store.get, wmhas = store.has,
    wmset = store.set;
  set = function (e, t) {
    return t.facade = e, wmset.call(store, e, t), t
  }, get = function (e) {
  ...
  hiddenKeys$1[STATE] = !0, set = function (e, t) {
...
var internalState = {set: set, get: get, has: has, enforce: enforce, getterFor: getterFor},
  redefine = createCommonjsModule((function (e) {
    var t = internalState.get, i = internalState.enforce, n = String(String).split("String");
    (e.exports = function (e, t, s, r) {
      var o, a = !!r && !!r.unsafe, l = !!r && !!r.enumerable, c = !!r && !!r.noTargetGet;
      "function" == typeof s && ("string" != typeof t || has$1(s, "name") || createNonEnumerableProperty(s, "name", t), (o = i(s)).source || (o.source = n.join("string" == typeof t ? t : ""))), e !== global_1 ? (a ? !c && e[t] && (l = !0) : delete e[t], l ? e[t] = s : createNonEnumerableProperty(e, t, s)) : l ? e[t] = s : setGlobal(t, s)
    ...
    return arguments.length < 2 ? aFunction$1(path[e]) || aFunction$1(global_1[e]) : path[e] && path[e][t] || global_1[e] && global_1[e][t]
  }, ceil = Math.ceil, floor$3 = Math.floor, toInteger = function (e) {
    return isNaN(e = +e) ? 0 : (e > 0 ? floor$3 : ceil)(e)
  }, min$2 = Math.min, toLength = function (e) {
    return e > 0 ? min$2(toInteger(e), 9007199254740991) : 0
  }, max$1 = Math.max, min$1 = Math.min, toAbsoluteIndex = function (e, t) {
    var i = toInteger(e);
    return i < 0 ? max$1(i + t, 0) : min$1(i, t)
  }, createMethod$1 = function (e) {
    return function (t, i, n) {
      var s, r = toIndexedObject(t), o = toLength(r.length), a = toAbsoluteIndex(n, o);
      if (e && i != i) {
  ...
  objectKeysInternal = function (e, t) {
    var i, n = toIndexedObject(e), s = 0, r = [];
    for (i in n) !has$1(hiddenKeys$1, i) && has$1(n, i) && r.push(i);
    for (; t.length > s;) has$1(n, i = t[s++]) && (~indexOf(r, i) || r.push(i));
    return r
  },
  enumBugKeys = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"],
  hiddenKeys = enumBugKeys.concat("length", "prototype"), f$1 = Object.getOwnPropertyNames || function (e) {
    return objectKeysInternal(e, hiddenKeys)
  }, objectGetOwnPropertyNames = {f: f$1}, f = Object.getOwnPropertySymbols, objectGetOwnPropertySymbols = {f: f},
  ownKeys$1 = getBuiltIn("Reflect", "ownKeys") || function (e) {
    var t = objectGetOwnPropertyNames.f(anObject(e)), i = objectGetOwnPropertySymbols.f;
    return i ? t.concat(i(e)) : t
  }, copyConstructorProperties = function (e, t) {
    for (var i = ownKeys$1(t), n = objectDefineProperty.f, s = objectGetOwnPropertyDescriptor.f, r = 0; r < i.length; r++) {
      var o = i[r];
      has$1(e, o) || n(e, o, s(t, o))
    }
  }, replacement = /#|\.prototype\./, isForced = function (e, t) {
    var i = data[normalize(e)];
    return i == POLYFILL || i != NATIVE && ("function" == typeof t ? fails(t) : !!t)
  }, normalize = isForced.normalize = function (e) {
    return String(e).replace(replacement, ".").toLowerCase()
  }, data = isForced.data = {}, NATIVE = isForced.NATIVE = "N", POLYFILL = isForced.POLYFILL = "P", isForced_1 = isForced,
  getOwnPropertyDescriptor = objectGetOwnPropertyDescriptor.f, _export = function (e, t) {
    var i, n, s, r, o, a = e.target, l = e.global, c = e.stat;
    if (i = l ? global_1 : c ? global_1[a] || setGlobal(a, {}) : (global_1[a] || {}).prototype) for (n in t) {
      if (r = t[n], s = e.noTargetGet ? (o = getOwnPropertyDescriptor(i, n)) && o.value : i[n], !isForced_1(l ? n : a + (c ? "." : "#") + n, e.forced) && void 0 !== s) {
        if (typeof r == typeof s) continue;
        copyConstructorProperties(r, s)
      }
      (e.sham || s && s.sham) && createNonEnumerableProperty(r, "sham", !0), redefine(i, n, r, e)
    }
...
var UNSUPPORTED_Y$1 = fails((function () {
  ...
  })), regexpStickyHelpers = {UNSUPPORTED_Y: UNSUPPORTED_Y$1, BROKEN_CARET: BROKEN_CARET},
  nativeExec = RegExp.prototype.exec, nativeReplace = shared("native-string-replace", String.prototype.replace),
  patchedExec = nativeExec, UPDATES_LAST_INDEX_WRONG = function () {
    var e = /a/, t = /b*/g;
    return nativeExec.call(e, "a"), nativeExec.call(t, "a"), 0 !== e.lastIndex || 0 !== t.lastIndex
  }(), UNSUPPORTED_Y = regexpStickyHelpers.UNSUPPORTED_Y || regexpStickyHelpers.BROKEN_CARET,
  NPCG_INCLUDED = void 0 !== /()??/.exec("")[1], PATCH = UPDATES_LAST_INDEX_WRONG || NPCG_INCLUDED || UNSUPPORTED_Y;
PATCH && (patchedExec = function (e) {
  var t, i, n, s, r = this, o = UNSUPPORTED_Y && r.sticky, a = regexpFlags.call(r), l = r.source, c = 0, u = e;
  return o && (-1 === (a = a.replace("y", "")).indexOf("g") && (a += "g"), u = String(e).slice(r.lastIndex), r.lastIndex > 0 && (!r.multiline || r.multiline && "\n" !== e[r.lastIndex - 1]) && (l = "(?: " + l + ")", u = " " + u, c++), i = new RegExp("^(?:" + l + ")", a)), NPCG_INCLUDED && (i = new RegExp("^" + l + "$(?!\\s)", a)), UPDATES_LAST_INDEX_WRONG && (t = r.lastIndex), n = nativeExec.call(o ? i : r, u), o ? n ? (n.input = n.input.slice(c), n[0] = n[0].slice(c), n.index = r.lastIndex, r.lastIndex += n[0].length) : r.lastIndex = 0 : UPDATES_LAST_INDEX_WRONG && n && (r.lastIndex = r.global ? n.index + n[0].length : t), NPCG_INCLUDED && n && n.length > 1 && nativeReplace.call(n[0], i, (function () {
    for (s = 1; s < arguments.length - 2; s++) void 0 === arguments[s] && (n[s] = void 0)
  })), n
});
var regexpExec = patchedExec;
_export({target: "RegExp", proto: !0, forced: /./.exec !== regexpExec}, {exec: regexpExec});
var match, version, engineIsNode = "process" == classofRaw(global_1.process),
  engineUserAgent = getBuiltIn("navigator", "userAgent") || "", process = global_1.process,
  versions = process && process.versions, v8 = versions && versions.v8;
...
var engineV8Version = version && +version, nativeSymbol = !!Object.getOwnPropertySymbols && !fails((function () {
    return !Symbol.sham && (engineIsNode ? 38 === engineV8Version : engineV8Version > 37 && engineV8Version < 41)
  ...
  }, SPECIES = wellKnownSymbol("species"), REPLACE_SUPPORTS_NAMED_GROUPS = !fails((function () {
    var e = /./;
    return e.exec = function () {
      var e = [];
      return e.groups = {a: "7"}, e
    }, "7" !== "".replace(e, "$<a>")
  })), REPLACE_KEEPS_$0 = "$0" === "a".replace(/./, "$0"), REPLACE = wellKnownSymbol("replace"),
  ...
  })), fixRegexpWellKnownSymbolLogic = function (e, t, i, n) {
    var s = wellKnownSymbol(e), r = !fails((function () {
      var t = {};
      return t[s] = function () {
        return 7
      }, 7 != ""[e](t)
      ...
      var t = !1, i = /a/;
      return "split" === e && ((i = {}).constructor = {}, i.constructor[SPECIES] = function () {
        return i
      }, i.flags = "", i[s] = /./[s]), i.exec = function () {
        return t = !0, null
      }, i[s](""), !t
    }));
    if (!r || !o || "replace" === e && (!REPLACE_SUPPORTS_NAMED_GROUPS || !REPLACE_KEEPS_$0 || REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE) || "split" === e && !SPLIT_WORKS_WITH_OVERWRITTEN_EXEC) {
      var a = /./[s], l = i(s, ""[e], (function (e, t, i, n, s) {
        return t.exec === RegExp.prototype.exec ? r && !s ? {done: !0, value: a.call(t, i, n)} : {
          done: !0,
          value: e.call(i, t, n)
        } : {done: !1}
      }), {
      ...
      redefine(String.prototype, e, c), redefine(RegExp.prototype, s, 2 == t ? function (e, t) {
        return u.call(e, this, t)
      } : function (e) {
        return u.call(e, this)
      })
    }
    n && createNonEnumerableProperty(RegExp.prototype[s], "sham", !0)
  }, createMethod = function (e) {
    return function (t, i) {
      var n, s, r = String(requireObjectCoercible(t)), o = toInteger(i), a = r.length;
      return o < 0 || o >= a ? e ? "" : void 0 : (n = r.charCodeAt(o)) < 55296 || n > 56319 || o + 1 === a || (s = r.charCodeAt(o + 1)) < 56320 || s > 57343 ? e ? r.charAt(o) : n : e ? r.slice(o, o + 2) : s - 56320 + (n - 55296 << 10) + 65536
    }
  }, stringMultibyte = {codeAt: createMethod(!1), charAt: createMethod(!0)}, charAt$1 = stringMultibyte.charAt,
  advanceStringIndex = function (e, t, i) {
    return t + (i ? charAt$1(e, t).length : 1)
  }, toObject = function (e) {
    return Object(requireObjectCoercible(e))
  }, floor$2 = Math.floor, replace$1 = "".replace, SUBSTITUTION_SYMBOLS = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
  SUBSTITUTION_SYMBOLS_NO_NAMED = /\$([$&'`]|\d{1,2})/g, getSubstitution = function (e, t, i, n, s, r) {
    var o = i + e.length, a = n.length, l = SUBSTITUTION_SYMBOLS_NO_NAMED;
    return void 0 !== s && (s = toObject(s), l = SUBSTITUTION_SYMBOLS), replace$1.call(r, l, (function (r, l) {
      var c;
      switch (l.charAt(0)) {
        case"$":
          return "$";
        ...
        default:
          ...
          if (u > a) {
            var h = floor$2(u / 10);
            return 0 === h ? r : h <= a ? void 0 === n[h - 1] ? l.charAt(1) : n[h - 1] + l.charAt(1) : r
          }
          c = n[u - 1]
      }
      return void 0 === c ? "" : c
  ...
  }, max = Math.max, min = Math.min, maybeToString = function (e) {
    return void 0 === e ? e : String(e)
  };
fixRegexpWellKnownSymbolLogic("replace", 2, (function (e, t, i, n) {
  var s = n.REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE, r = n.REPLACE_KEEPS_$0, o = s ? "$" : "$0";
  return [function (i, n) {
    var s = requireObjectCoercible(this), r = null == i ? void 0 : i[e];
    return void 0 !== r ? r.call(i, s, n) : t.call(String(s), i, n)
  }, function (e, n) {
    if (!s && r || "string" == typeof n && -1 === n.indexOf(o)) {
      var a = i(t, e, this, n);
      if (a.done) return a.value
    }
    var l = anObject(e), c = String(this), u = "function" == typeof n;
    u || (n = String(n));
    var h = l.global;
    if (h) {
      var d = l.unicode;
    ...
    for (var p = []; ;) {
      var m = regexpExecAbstract(l, c);
      if (null === m) break;
      if (p.push(m), !h) break;
      "" === String(m[0]) && (l.lastIndex = advanceStringIndex(c, toLength(l.lastIndex), d))
    }
    for (var g = "", f = 0, y = 0; y < p.length; y++) {
      m = p[y];
      for (var b = String(m[0]), v = max(min(toInteger(m.index), c.length), 0), E = [], S = 1; S < m.length; S++) E.push(maybeToString(m[S]));
      var T = m.groups;
      if (u) {
        var w = [b].concat(E, v, c);
        void 0 !== T && w.push(T);
        var P = String(n.apply(void 0, w))
      } else P = getSubstitution(b, c, v, E, T, n);
      v >= f && (g += c.slice(f, v) + P, f = v + b.length)
    }
    return g + c.slice(f)
  }]
}));
var IteratorPrototype$2, PrototypeOfArrayIteratorPrototype, arrayIterator,
  ...
  objectGetPrototypeOf = correctPrototypeGetter ? Object.getPrototypeOf : function (e) {
    return e = toObject(e), has$1(e, IE_PROTO$1) ? e[IE_PROTO$1] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? ObjectPrototype : null
  }, ITERATOR$5 = wellKnownSymbol("iterator"), BUGGY_SAFARI_ITERATORS$1 = !1, returnThis$2 = function () {
    return this
  };
[].keys && ("next" in (arrayIterator = [].keys()) ? (PrototypeOfArrayIteratorPrototype = objectGetPrototypeOf(objectGetPrototypeOf(arrayIterator))) !== Object.prototype && (IteratorPrototype$2 = PrototypeOfArrayIteratorPrototype) : BUGGY_SAFARI_ITERATORS$1 = !0);
...
var activeXDocument,
  iteratorsCore = {IteratorPrototype: IteratorPrototype$2, BUGGY_SAFARI_ITERATORS: BUGGY_SAFARI_ITERATORS$1},
  objectKeys = Object.keys || function (e) {
    ...
    anObject(e);
    for (var i, n = objectKeys(t), s = n.length, r = 0; s > r;) objectDefineProperty.f(e, i = n[r++], t[i]);
    return e
  ...
  IE_PROTO = sharedKey("IE_PROTO"), EmptyConstructor = function () {
    ...
    return t.style.display = "none", html.appendChild(t), t.src = String(i), (e = t.contentWindow.document).open(), e.write(scriptTag("document.F=Object")), e.close(), e.F
...
var objectCreate = Object.create || function (e, t) {
    var i;
    return null !== e ? (EmptyConstructor[PROTOTYPE] = anObject(e), i = new EmptyConstructor, EmptyConstructor[PROTOTYPE] = null, i[IE_PROTO] = e) : i = NullProtoObject(), void 0 === t ? i : objectDefineProperties(i, t)
  }, defineProperty$1 = objectDefineProperty.f, TO_STRING_TAG$2 = wellKnownSymbol("toStringTag"),
  setToStringTag = function (e, t, i) {
    e && !has$1(e = i ? e : e.prototype, TO_STRING_TAG$2) && defineProperty$1(e, TO_STRING_TAG$2, {
      configurable: !0,
      value: t
    })
  }, iterators = {}, IteratorPrototype$1 = iteratorsCore.IteratorPrototype, returnThis$1 = function () {
    return this
  }, createIteratorConstructor = function (e, t, i) {
    var n = t + " Iterator";
    return e.prototype = objectCreate(IteratorPrototype$1, {next: createPropertyDescriptor(1, i)}), setToStringTag(e, n, !1), iterators[n] = returnThis$1, e
  }, aPossiblePrototype = function (e) {
    if (!isObject$2(e) && null !== e) throw TypeError("Can't set " + String(e) + " as a prototype");
    return e
    ...
    return function (i, n) {
      return anObject(i), aPossiblePrototype(n), t ? e.call(i, n) : i.__proto__ = n, i
    }
  ...
  KEYS = "keys", VALUES = "values", ENTRIES = "entries", returnThis = function () {
    return this
  }, defineIterator = function (e, t, i, n, s, r, o) {
    createIteratorConstructor(i, t, n);
    var a, l, c, u = function (e) {
        if (e === s && g) return g;
        if (!BUGGY_SAFARI_ITERATORS && e in p) return p[e];
        switch (e) {
          case KEYS:
          case VALUES:
          case ENTRIES:
      ...
      }, h = t + " Iterator", d = !1, p = e.prototype, m = p[ITERATOR$4] || p["@@iterator"] || s && p[s],
      g = !BUGGY_SAFARI_ITERATORS && m || u(s), f = "Array" == t && p.entries || m;
    if (f && (a = objectGetPrototypeOf(f.call(new e)), IteratorPrototype !== Object.prototype && a.next && (objectGetPrototypeOf(a) !== IteratorPrototype && (objectSetPrototypeOf ? objectSetPrototypeOf(a, IteratorPrototype) : "function" != typeof a[ITERATOR$4] && createNonEnumerableProperty(a, ITERATOR$4, returnThis)), setToStringTag(a, h, !0))), s == VALUES && m && m.name !== VALUES && (d = !0, g = function () {
      return m.call(this)
    }), p[ITERATOR$4] !== g && createNonEnumerableProperty(p, ITERATOR$4, g), iterators[t] = g, s) if (l = {
      values: u(VALUES),
      keys: r ? g : u(KEYS),
      entries: u(ENTRIES)
    }, o) for (c in l) (BUGGY_SAFARI_ITERATORS || d || !(c in p)) && redefine(p, c, l[c]); else _export({
      target: t,
      proto: !0,
      forced: BUGGY_SAFARI_ITERATORS || d
    }, l);
    return l
  }, charAt = stringMultibyte.charAt, STRING_ITERATOR = "String Iterator", setInternalState$3 = internalState.set,
  getInternalState$1 = internalState.getterFor(STRING_ITERATOR);
defineIterator(String, "String", (function (e) {
  setInternalState$3(this, {type: STRING_ITERATOR, string: String(e), index: 0})
}), (function () {
  var e, t = getInternalState$1(this), i = t.string, n = t.index;
  return n >= i.length ? {value: void 0, done: !0} : (e = charAt(i, n), t.index += e.length, {value: e, done: !1})
}));
var ITERATOR$3 = wellKnownSymbol("iterator"), nativeUrl = !fails((function () {
  var e = new URL("b?a=1&b=2&c=3", "http://a"), t = e.searchParams, i = "";
  return e.pathname = "c%20d", t.forEach((function (e, n) {
    t.delete("b"), i += n + e
  })), isPure && !e.toJSON || !t.sort || "http://a/c%20d?a=1&c=3" !== e.href || "3" !== t.get("c") || "a=1" !== String(new URLSearchParams("?a=1")) || !t[ITERATOR$3] || "a" !== new URL("https://a@b").username || "b" !== new URLSearchParams(new URLSearchParams("a=b")).get("a") || "xn--e1aybc" !== new URL("http://тест").host || "#%D0%B1" !== new URL("http://a#б").hash || "a1c3" !== i || "x" !== new URL("http://x", void 0).host
})), anInstance = function (e, t, i) {
  if (!(e instanceof t)) throw TypeError("Incorrect " + (i ? i + " " : "") + "invocation");
  return e
}, $assign = Object.assign, defineProperty = Object.defineProperty, objectAssign = !$assign || fails((function () {
  ...
  return e[i] = 7, n.split("").forEach((function (e) {
    t[e] = e
  })), 7 != $assign({}, e)[i] || objectKeys($assign({}, t)).join("") != n
})) ? function (e, t) {
  for (var i = toObject(e), n = arguments.length, s = 1, r = objectGetOwnPropertySymbols.f, o = objectPropertyIsEnumerable.f; n > s;) for (var a, l = indexedObject(arguments[s++]), c = r ? objectKeys(l).concat(r(l)) : objectKeys(l), u = c.length, h = 0; u > h;) a = c[h++], descriptors && !o.call(l, a) || (i[a] = l[a]);
  return i
} : $assign, aFunction = function (e) {
  if ("function" != typeof e) throw TypeError(String(e) + " is not a function");
  return e
}, functionBindContext = function (e, t, i) {
  if (aFunction(e), void 0 === t) return e;
  switch (i) {
    case 0:
      return function () {
        return e.call(t)
  ...
  var t = e.return;
  if (void 0 !== t) return anObject(t.call(e)).value
}, callWithSafeIterationClosing = function (e, t, i, n) {
  try {
    return n ? t(anObject(i)[0], i[1]) : t(i)
  } catch (t) {
    throw iteratorClose(e), t
  }
}, ITERATOR$2 = wellKnownSymbol("iterator"), ArrayPrototype$1 = Array.prototype, isArrayIteratorMethod = function (e) {
  return void 0 !== e && (iterators.Array === e || ArrayPrototype$1[ITERATOR$2] === e)
}, createProperty = function (e, t, i) {
  var n = toPrimitive(t);
  n in e ? objectDefineProperty.f(e, n, createPropertyDescriptor(0, i)) : e[n] = i
}, TO_STRING_TAG$1 = wellKnownSymbol("toStringTag"), test = {};
test[TO_STRING_TAG$1] = "z";
var toStringTagSupport = "[object z]" === String(test), TO_STRING_TAG = wellKnownSymbol("toStringTag"),
  CORRECT_ARGUMENTS = "Arguments" == classofRaw(function () {
    ...
    var t, i, n;
    return void 0 === e ? "Undefined" : null === e ? "Null" : "string" == typeof (i = tryGet(t = Object(e), TO_STRING_TAG)) ? i : CORRECT_ARGUMENTS ? classofRaw(t) : "Object" == (n = classofRaw(t)) && "function" == typeof t.callee ? "Arguments" : n
  }, ITERATOR$1 = wellKnownSymbol("iterator"), getIteratorMethod = function (e) {
    if (null != e) return e[ITERATOR$1] || e["@@iterator"] || iterators[classof(e)]
  }, arrayFrom = function (e) {
    var t, i, n, s, r, o, a = toObject(e), l = "function" == typeof this ? this : Array, c = arguments.length,
      u = c > 1 ? arguments[1] : void 0, h = void 0 !== u, d = getIteratorMethod(a), p = 0;
    if (h && (u = functionBindContext(u, c > 2 ? arguments[2] : void 0, 2)), null == d || l == Array && isArrayIteratorMethod(d)) for (i = new l(t = toLength(a.length)); t > p; p++) o = h ? u(a[p], p) : a[p], createProperty(i, p, o); else for (r = (s = d.call(a)).next, i = new l; !(n = r.call(s)).done; p++) o = h ? callWithSafeIterationClosing(s, u, [n.value, p], !0) : n.value, createProperty(i, p, o);
    return i.length = p, i
  }, maxInt = 2147483647, base = 36, tMin = 1, tMax = 26, skew = 38, damp = 700, initialBias = 72, initialN = 128,
  delimiter = "-", regexNonASCII = /[^\0-\u007E]/, regexSeparators = /[.\u3002\uFF0E\uFF61]/g,
  OVERFLOW_ERROR = "Overflow: input needs wider integers to process", baseMinusTMin = base - tMin, floor$1 = Math.floor,
  stringFromCharCode = String.fromCharCode, ucs2decode = function (e) {
    ...
    var n = 0;
    for (e = i ? floor$1(e / damp) : e >> 1, e += floor$1(e / t); e > baseMinusTMin * tMax >> 1; n += base) e = floor$1(e / baseMinusTMin);
    return floor$1(n + (baseMinusTMin + 1) * e / (e + skew))
  }, encode = function (e) {
    var t, i, n = [], s = (e = ucs2decode(e)).length, r = initialN, o = 0, a = initialBias;
    for (t = 0; t < e.length; t++) (i = e[t]) < 128 && n.push(stringFromCharCode(i));
    var l = n.length, c = l;
    for (l && n.push(delimiter); c < s;) {
      var u = maxInt;
      for (t = 0; t < e.length; t++) (i = e[t]) >= r && i < u && (u = i);
      var h = c + 1;
      if (u - r > floor$1((maxInt - o) / h)) throw RangeError(OVERFLOW_ERROR);
      for (o += (u - r) * h, r = u, t = 0; t < e.length; t++) {
        if ((i = e[t]) < r && ++o > maxInt) throw RangeError(OVERFLOW_ERROR);
        if (i == r) {
          for (var d = o, p = base; ; p += base) {
            var m = p <= a ? tMin : p >= a + tMax ? tMax : p - a;
            if (d < m) break;
            var g = d - m, f = base - m;
            n.push(stringFromCharCode(digitToBasic(m + g % f))), d = floor$1(g / f)
          }
          n.push(stringFromCharCode(digitToBasic(d))), a = adapt(o, h, c == l), o = 0, ++c
        }
      }
      ++o, ++r
    }
    ...
    var t, i, n = [], s = e.toLowerCase().replace(regexSeparators, ".").split(".");
    for (t = 0; t < s.length; t++) i = s[t], n.push(regexNonASCII.test(i) ? "xn--" + encode(i) : i);
    return n.join(".")
  }, UNSCOPABLES = wellKnownSymbol("unscopables"), ArrayPrototype = Array.prototype;
...
var addToUnscopables = function (e) {
  ...
  }, ARRAY_ITERATOR = "Array Iterator", setInternalState$2 = internalState.set,
  getInternalState = internalState.getterFor(ARRAY_ITERATOR);
defineIterator(Array, "Array", (function (e, t) {
  setInternalState$2(this, {type: ARRAY_ITERATOR, target: toIndexedObject(e), index: 0, kind: t})
}), (function () {
  var e = getInternalState(this), t = e.target, i = e.kind, n = e.index++;
...
var redefineAll = function (e, t, i) {
    for (var n in t) redefine(e, n, t[n], i);
    return e
  }, getIterator = function (e) {
    var t = getIteratorMethod(e);
    if ("function" != typeof t) throw TypeError(String(e) + " is not iterable");
    return anObject(t.call(e))
  }, $fetch = getBuiltIn("fetch"), Headers = getBuiltIn("Headers"), ITERATOR = wellKnownSymbol("iterator"),
  URL_SEARCH_PARAMS = "URLSearchParams", URL_SEARCH_PARAMS_ITERATOR = URL_SEARCH_PARAMS + "Iterator",
  setInternalState$1 = internalState.set, getInternalParamsState = internalState.getterFor(URL_SEARCH_PARAMS),
  getInternalIteratorState = internalState.getterFor(URL_SEARCH_PARAMS_ITERATOR), plus = /\+/g, sequences = Array(4),
  percentSequence = function (e) {
    ...
    var t = e.replace(plus, " "), i = 4;
    try {
      return decodeURIComponent(t)
    } catch (e) {
      for (; i;) t = t.replace(percentSequence(i--), percentDecode);
      return t
    }
  }, find = /[!'()~]|%20/g, replace = {"!": "%21", "'": "%27", "(": "%28", ")": "%29", "~": "%7E", "%20": "+"},
  replacer = function (e) {
    return replace[e]
  }, serialize = function (e) {
    return encodeURIComponent(e).replace(find, replacer)
  }, parseSearchParams = function (e, t) {
    if (t) for (var i, n, s = t.split("&"), r = 0; r < s.length;) (i = s[r++]).length && (n = i.split("="), e.push({
    ...
    var e = getInternalIteratorState(this), t = e.kind, i = e.iterator.next(), n = i.value;
    return i.done || (i.value = "keys" === t ? n.key : "values" === t ? n.value : [n.key, n.value]), i
  })), URLSearchParamsConstructor = function () {
    anInstance(this, URLSearchParamsConstructor, URL_SEARCH_PARAMS);
    var e, t, i, n, s, r, o, a, l, c = arguments.length > 0 ? arguments[0] : void 0, u = this, h = [];
    if (setInternalState$1(u, {
      type: URL_SEARCH_PARAMS, entries: h, updateURL: function () {
      }, updateSearchParams: updateSearchParams
    }), void 0 !== c) if (isObject$2(c)) if ("function" == typeof (e = getIteratorMethod(c))) for (i = (t = e.call(c)).next; !(n = i.call(t)).done;) {
      if ((o = (r = (s = getIterator(anObject(n.value))).next).call(s)).done || (a = r.call(s)).done || !r.call(s).done) throw TypeError("Expected sequence with length 2");
      h.push({key: o.value + "", value: a.value + ""})
    } else for (l in c) has$1(c, l) && h.push({
      key: l,
      value: c[l] + ""
    }); else parseSearchParams(h, "string" == typeof c ? "?" === c.charAt(0) ? c.slice(1) : c : c + "")
...
redefineAll(URLSearchParamsPrototype, {
  append: function (e, t) {
    ...
    for (var t = getInternalParamsState(this), i = t.entries, n = e + "", s = 0; s < i.length;) i[s].key === n ? i.splice(s, 1) : s++;
    t.updateURL()
  }, get: function (e) {
    validateArgumentsLength(arguments.length, 1);
    for (var t = getInternalParamsState(this).entries, i = e + "", n = 0; n < t.length; n++) if (t[n].key === i) return t[n].value;
    return null
  }, getAll: function (e) {
    validateArgumentsLength(arguments.length, 1);
    for (var t = getInternalParamsState(this).entries, i = e + "", n = [], s = 0; s < t.length; s++) t[s].key === i && n.push(t[s].value);
    return n
  }, has: function (e) {
    validateArgumentsLength(arguments.length, 1);
    for (var t = getInternalParamsState(this).entries, i = e + "", n = 0; n < t.length;) if (t[n++].key === i) return !0;
    return !1
  }, set: function (e, t) {
    validateArgumentsLength(arguments.length, 1);
    for (var i, n = getInternalParamsState(this), s = n.entries, r = !1, o = e + "", a = t + "", l = 0; l < s.length; l++) (i = s[l]).key === o && (r ? s.splice(l--, 1) : (r = !0, i.value = a));
    r || s.push({key: o, value: a}), n.updateURL()
  }, sort: function () {
    var e, t, i, n = getInternalParamsState(this), s = n.entries, r = s.slice();
    for (s.length = 0, i = 0; i < r.length; i++) {
      for (e = r[i], t = 0; t < i; t++) if (s[t].key > e.key) {
        s.splice(t, 0, e);
        break
      }
      t === i && s.push(e)
    ...
    for (var t, i = getInternalParamsState(this).entries, n = functionBindContext(e, arguments.length > 1 ? arguments[1] : void 0, 3), s = 0; s < i.length;) n((t = i[s++]).value, t.key, this)
  }, keys: function () {
...
}, {enumerable: !0}), redefine(URLSearchParamsPrototype, ITERATOR, URLSearchParamsPrototype.entries), redefine(URLSearchParamsPrototype, "toString", (function () {
  for (var e, t = getInternalParamsState(this).entries, i = [], n = 0; n < t.length;) e = t[n++], i.push(serialize(e.key) + "=" + serialize(e.value));
  return i.join("&")
}), {enumerable: !0}), setToStringTag(URLSearchParamsConstructor, URL_SEARCH_PARAMS), _export({
  global: !0,
  forced: !nativeUrl
}, {URLSearchParams: URLSearchParamsConstructor}), nativeUrl || "function" != typeof $fetch || "function" != typeof Headers || _export({
  global: !0,
  enumerable: !0,
  forced: !0
}, {
  fetch: function (e) {
    var t, i, n, s = [e];
    return arguments.length > 1 && (isObject$2(t = arguments[1]) && (i = t.body, classof(i) === URL_SEARCH_PARAMS && ((n = t.headers ? new Headers(t.headers) : new Headers).has("content-type") || n.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"), t = objectCreate(t, {
      body: createPropertyDescriptor(0, String(i)),
      headers: createPropertyDescriptor(0, n)
    }))), s.push(t)), $fetch.apply(this, s)
  }
});
var EOF, web_urlSearchParams = {URLSearchParams: URLSearchParamsConstructor, getState: getInternalParamsState},
  codeAt = stringMultibyte.codeAt, NativeURL = global_1.URL, URLSearchParams$1 = web_urlSearchParams.URLSearchParams,
  getInternalSearchParamsState = web_urlSearchParams.getState, setInternalState = internalState.set,
  getInternalURLState = internalState.getterFor("URL"), floor = Math.floor, pow = Math.pow,
  INVALID_AUTHORITY = "Invalid authority", INVALID_SCHEME = "Invalid scheme", INVALID_HOST = "Invalid host",
  INVALID_PORT = "Invalid port", ALPHA = /[A-Za-z]/, ALPHANUMERIC = /[\d+-.A-Za-z]/, DIGIT = /\d/,
  HEX_START = /^(0x|0X)/, OCT = /^[0-7]+$/, DEC = /^\d+$/, HEX = /^[\dA-Fa-f]+$/,
  ...
  TAB_AND_NEW_LINE = /[\t\u000A\u000D]/g, parseHost = function (e, t) {
    ...
    if ("[" == t.charAt(0)) {
      ...
      if (!(i = parseIPv6(t.slice(1, -1)))) return INVALID_HOST;
      e.host = i
    } else if (isSpecial(e)) {
      if (t = stringPunycodeToAscii(t), FORBIDDEN_HOST_CODE_POINT.test(t)) return INVALID_HOST;
      if (null === (i = parseIPv4(t))) return INVALID_HOST;
      e.host = i
    } else {
      if (FORBIDDEN_HOST_CODE_POINT_EXCLUDING_PERCENT.test(t)) return INVALID_HOST;
      for (i = "", n = arrayFrom(t), s = 0; s < n.length; s++) i += percentEncode(n[s], C0ControlPercentEncodeSet);
      e.host = i
    }
  }, parseIPv4 = function (e) {
    var t, i, n, s, r, o, a, l = e.split(".");
    if (l.length && "" == l[l.length - 1] && l.pop(), (t = l.length) > 4) return e;
    for (i = [], n = 0; n < t; n++) {
      if ("" == (s = l[n])) return e;
      if (r = 10, s.length > 1 && "0" == s.charAt(0) && (r = HEX_START.test(s) ? 16 : 8, s = s.slice(8 == r ? 1 : 2)), "" === s) o = 0; else {
        if (!(10 == r ? DEC : 8 == r ? OCT : HEX).test(s)) return e;
        o = parseInt(s, r)
      }
      i.push(o)
    }
    for (n = 0; n < t; n++) if (o = i[n], n == t - 1) {
      if (o >= pow(256, 5 - t)) return null
    } else if (o > 255) return null;
    for (a = i.pop(), n = 0; n < i.length; n++) a += i[n] * pow(256, 3 - n);
    return a
  }, parseIPv6 = function (e) {
    var t, i, n, s, r, o, a, l = [0, 0, 0, 0, 0, 0, 0, 0], c = 0, u = null, h = 0, d = function () {
      return e.charAt(h)
    };
    if (":" == d()) {
    ...
    for (; d();) {
      if (8 == c) return;
      if (":" != d()) {
        for (t = i = 0; i < 4 && HEX.test(d());) t = 16 * t + parseInt(d(), 16), h++, i++;
        if ("." == d()) {
          if (0 == i) return;
          if (h -= i, c > 6) return;
          for (n = 0; d();) {
            ...
            if (!DIGIT.test(d())) return;
            for (; DIGIT.test(d());) {
              if (r = parseInt(d(), 10), null === s) s = r; else {
                if (0 == s) return;
                s = 10 * s + r
              }
              if (s > 255) return;
    ...
    if (null !== u) for (o = c - u, c = 7; 0 != c && o > 0;) a = l[c], l[c--] = l[u + o - 1], l[u + --o] = a; else if (8 != c) return;
    return l
  }, findLongestZeroSequence = function (e) {
    for (var t = null, i = 1, n = null, s = 0, r = 0; r < 8; r++) 0 !== e[r] ? (s > i && (t = n, i = s), n = null, s = 0) : (null === n && (n = r), ++s);
    return s > i && (t = n, i = s), t
  }, serializeHost = function (e) {
    var t, i, n, s;
    if ("number" == typeof e) {
      for (t = [], i = 0; i < 4; i++) t.unshift(e % 256), e = floor(e / 256);
      return t.join(".")
    }
    if ("object" == typeof e) {
      for (t = "", n = findLongestZeroSequence(e), i = 0; i < 8; i++) s && 0 === e[i] || (s && (s = !1), n === i ? (t += i ? ":" : "::", s = !0) : (t += e[i].toString(16), i < 7 && (t += ":")));
      return "[" + t + "]"
    }
    return e
  }, C0ControlPercentEncodeSet = {},
  fragmentPercentEncodeSet = objectAssign({}, C0ControlPercentEncodeSet, {" ": 1, '"': 1, "<": 1, ">": 1, "`": 1}),
  pathPercentEncodeSet = objectAssign({}, fragmentPercentEncodeSet, {"#": 1, "?": 1, "{": 1, "}": 1}),
  userinfoPercentEncodeSet = objectAssign({}, pathPercentEncodeSet, {
    ...
    var i = codeAt(e, 0);
    return i > 32 && i < 127 && !has$1(t, e) ? e : encodeURIComponent(e)
  }, specialSchemes = {ftp: 21, file: null, http: 80, https: 443, ws: 80, wss: 443}, isSpecial = function (e) {
    ...
    var i;
    return 2 == e.length && ALPHA.test(e.charAt(0)) && (":" == (i = e.charAt(1)) || !t && "|" == i)
    ...
    !i || "file" == e.scheme && 1 == i && isWindowsDriveLetter(t[0], !0) || t.pop()
  }, isSingleDot = function (e) {
    return "." === e || "%2e" === e.toLowerCase()
  }, isDoubleDot = function (e) {
    return ".." === (e = e.toLowerCase()) || "%2e." === e || ".%2e" === e || "%2e%2e" === e
  }, SCHEME_START = {}, SCHEME = {}, NO_SCHEME = {}, SPECIAL_RELATIVE_OR_AUTHORITY = {}, PATH_OR_AUTHORITY = {},
  RELATIVE = {}, RELATIVE_SLASH = {}, SPECIAL_AUTHORITY_SLASHES = {}, SPECIAL_AUTHORITY_IGNORE_SLASHES = {},
  AUTHORITY = {}, HOST = {}, HOSTNAME = {}, PORT = {}, FILE = {}, FILE_SLASH = {}, FILE_HOST = {}, PATH_START = {},
  PATH = {}, CANNOT_BE_A_BASE_URL_PATH = {}, QUERY = {}, FRAGMENT = {}, parseURL = function (e, t, i, n) {
    var s, r, o, a, l = i || SCHEME_START, c = 0, u = "", h = !1, d = !1, p = !1;
    for (i || (e.scheme = "", e.username = "", e.password = "", e.host = null, e.port = null, e.path = [], e.query = null, e.fragment = null, e.cannotBeABaseURL = !1, t = t.replace(LEADING_AND_TRAILING_C0_CONTROL_OR_SPACE, "")), t = t.replace(TAB_AND_NEW_LINE, ""), s = arrayFrom(t); c <= s.length;) {
      switch (r = s[c], l) {
        case SCHEME_START:
          if (!r || !ALPHA.test(r)) {
            if (i) return INVALID_SCHEME;
            l = NO_SCHEME;
            continue
          }
          u += r.toLowerCase(), l = SCHEME;
          break;
        case SCHEME:
          if (r && (ALPHANUMERIC.test(r) || "+" == r || "-" == r || "." == r)) u += r.toLowerCase(); else {
            if (":" != r) {
              if (i) return INVALID_SCHEME;
              u = "", l = NO_SCHEME, c = 0;
              continue
            }
            if (i && (isSpecial(e) != has$1(specialSchemes, u) || "file" == u && (includesCredentials(e) || null !== e.port) || "file" == e.scheme && !e.host)) return;
            if (e.scheme = u, i) return void (isSpecial(e) && specialSchemes[e.scheme] == e.port && (e.port = null));
            u = "", "file" == e.scheme ? l = FILE : isSpecial(e) && n && n.scheme == e.scheme ? l = SPECIAL_RELATIVE_OR_AUTHORITY : isSpecial(e) ? l = SPECIAL_AUTHORITY_SLASHES : "/" == s[c + 1] ? (l = PATH_OR_AUTHORITY, c++) : (e.cannotBeABaseURL = !0, e.path.push(""), l = CANNOT_BE_A_BASE_URL_PATH)
          }
          break;
        case NO_SCHEME:
          if (!n || n.cannotBeABaseURL && "#" != r) return INVALID_SCHEME;
          if (n.cannotBeABaseURL && "#" == r) {
            e.scheme = n.scheme, e.path = n.path.slice(), e.query = n.query, e.fragment = "", e.cannotBeABaseURL = !0, l = FRAGMENT;
            break
          }
          l = "file" == n.scheme ? FILE : RELATIVE;
          continue;
        ...
        case PATH_OR_AUTHORITY:
          ...
          continue;
        case RELATIVE:
          if (e.scheme = n.scheme, r == EOF) e.username = n.username, e.password = n.password, e.host = n.host, e.port = n.port, e.path = n.path.slice(), e.query = n.query; else if ("/" == r || "\\" == r && isSpecial(e)) l = RELATIVE_SLASH; else if ("?" == r) e.username = n.username, e.password = n.password, e.host = n.host, e.port = n.port, e.path = n.path.slice(), e.query = "", l = QUERY; else {
            if ("#" != r) {
              e.username = n.username, e.password = n.password, e.host = n.host, e.port = n.port, e.path = n.path.slice(), e.path.pop(), l = PATH;
              continue
            }
            e.username = n.username, e.password = n.password, e.host = n.host, e.port = n.port, e.path = n.path.slice(), e.query = n.query, e.fragment = "", l = FRAGMENT
          }
          break;
        case RELATIVE_SLASH:
          if (!isSpecial(e) || "/" != r && "\\" != r) {
            if ("/" != r) {
              e.username = n.username, e.password = n.password, e.host = n.host, e.port = n.port, l = PATH;
              continue
            }
            l = AUTHORITY
        ...
        case SPECIAL_AUTHORITY_SLASHES:
          if (l = SPECIAL_AUTHORITY_IGNORE_SLASHES, "/" != r || "/" != u.charAt(c + 1)) continue;
          c++;
          break;
        ...
        case AUTHORITY:
          if ("@" == r) {
            h && (u = "%40" + u), h = !0, o = arrayFrom(u);
            for (var m = 0; m < o.length; m++) {
              var g = o[m];
              if (":" != g || p) {
                var f = percentEncode(g, userinfoPercentEncodeSet);
                p ? e.password += f : e.username += f
              } else p = !0
            }
            u = ""
          } else if (r == EOF || "/" == r || "?" == r || "#" == r || "\\" == r && isSpecial(e)) {
            if (h && "" == u) return INVALID_AUTHORITY;
        ...
        case HOSTNAME:
          ...
          if (":" != r || d) {
            if (r == EOF || "/" == r || "?" == r || "#" == r || "\\" == r && isSpecial(e)) {
              if (isSpecial(e) && "" == u) return INVALID_HOST;
              if (i && "" == u && (includesCredentials(e) || null !== e.port)) return;
              if (a = parseHost(e, u)) return a;
              if (u = "", l = PATH_START, i) return;
              continue
            }
            "[" == r ? d = !0 : "]" == r && (d = !1), u += r
          } else {
            ...
            if (a = parseHost(e, u)) return a;
            if (u = "", l = PORT, i == HOSTNAME) return
          }
          break;
        case PORT:
          if (!DIGIT.test(r)) {
            if (r == EOF || "/" == r || "?" == r || "#" == r || "\\" == r && isSpecial(e) || i) {
              if ("" != u) {
                var y = parseInt(u, 10);
          ...
          break;
        case FILE:
          if (e.scheme = "file", "/" == r || "\\" == r) l = FILE_SLASH; else {
            if (!n || "file" != n.scheme) {
              l = PATH;
              continue
            }
            if (r == EOF) e.host = n.host, e.path = n.path.slice(), e.query = n.query; else if ("?" == r) e.host = n.host, e.path = n.path.slice(), e.query = "", l = QUERY; else {
              if ("#" != r) {
                startsWithWindowsDriveLetter(s.slice(c).join("")) || (e.host = n.host, e.path = n.path.slice(), shortenURLsPath(e)), l = PATH;
                continue
              }
              e.host = n.host, e.path = n.path.slice(), e.query = n.query, e.fragment = "", l = FRAGMENT
            }
          }
          break;
        case FILE_SLASH:
          ...
          n && "file" == n.scheme && !startsWithWindowsDriveLetter(s.slice(c).join("")) && (isWindowsDriveLetter(n.path[0], !0) ? e.path.push(n.path[0]) : e.host = n.host), l = PATH;
          continue;
        case FILE_HOST:
          if (r == EOF || "/" == r || "\\" == r || "?" == r || "#" == r) {
            if (!i && isWindowsDriveLetter(u)) l = PATH; else if ("" == u) {
              if (e.host = "", i) return;
              l = PATH_START
            } else {
              if (a = parseHost(e, u)) return a;
        ...
        case PATH_START:
          if (isSpecial(e)) {
            if (l = PATH, "/" != r && "\\" != r) continue
          } else if (i || "?" != r) if (i || "#" != r) {
            if (r != EOF && (l = PATH, "/" != r)) continue
          } else e.fragment = "", l = FRAGMENT; else e.query = "", l = QUERY;
          break;
        case PATH:
          if (r == EOF || "/" == r || "\\" == r && isSpecial(e) || !i && ("?" == r || "#" == r)) {
            if (isDoubleDot(u) ? (shortenURLsPath(e), "/" == r || "\\" == r && isSpecial(e) || e.path.push("")) : isSingleDot(u) ? "/" == r || "\\" == r && isSpecial(e) || e.path.push("") : ("file" == e.scheme && !e.path.length && isWindowsDriveLetter(u) && (e.host && (e.host = ""), u = u.charAt(0) + ":"), e.path.push(u)), u = "", "file" == e.scheme && (r == EOF || "?" == r || "#" == r)) for (; e.path.length > 1 && "" === e.path[0];) e.path.shift();
            "?" == r ? (e.query = "", l = QUERY) : "#" == r && (e.fragment = "", l = FRAGMENT)
          } else u += percentEncode(r, pathPercentEncodeSet);
          break;
        case CANNOT_BE_A_BASE_URL_PATH:
          "?" == r ? (e.query = "", l = QUERY) : "#" == r ? (e.fragment = "", l = FRAGMENT) : r != EOF && (e.path[0] += percentEncode(r, C0ControlPercentEncodeSet));
          break;
        case QUERY:
          i || "#" != r ? r != EOF && ("'" == r && isSpecial(e) ? e.query += "%27" : e.query += "#" == r ? "%23" : percentEncode(r, C0ControlPercentEncodeSet)) : (e.fragment = "", l = FRAGMENT);
          break;
        case FRAGMENT:
          r != EOF && (e.fragment += percentEncode(r, fragmentPercentEncodeSet))
      }
      c++
    }
  }, URLConstructor = function (e) {
    var t, i, n = anInstance(this, URLConstructor, "URL"), s = arguments.length > 1 ? arguments[1] : void 0,
      r = String(e), o = setInternalState(n, {type: "URL"});
    if (void 0 !== s) if (s instanceof URLConstructor) t = getInternalURLState(s); else if (i = parseURL(t = {}, String(s))) throw TypeError(i);
    if (i = parseURL(o, r, null, t)) throw TypeError(i);
    var a = o.searchParams = new URLSearchParams$1, l = getInternalSearchParamsState(a);
    l.updateSearchParams(o.query), l.updateURL = function () {
      o.query = String(a) || null
    }, descriptors || (n.href = serializeURL.call(n), n.origin = getOrigin.call(n), n.protocol = getProtocol.call(n), n.username = getUsername.call(n), n.password = getPassword.call(n), n.host = getHost$1.call(n), n.hostname = getHostname.call(n), n.port = getPort.call(n), n.pathname = getPathname.call(n), n.search = getSearch.call(n), n.searchParams = getSearchParams.call(n), n.hash = getHash.call(n))
  }, URLPrototype = URLConstructor.prototype, serializeURL = function () {
    var e = getInternalURLState(this), t = e.scheme, i = e.username, n = e.password, s = e.host, r = e.port, o = e.path,
      a = e.query, l = e.fragment, c = t + ":";
    return null !== s ? (c += "//", includesCredentials(e) && (c += i + (n ? ":" + n : "") + "@"), c += serializeHost(s), null !== r && (c += ":" + r)) : "file" == t && (c += "//"), c += e.cannotBeABaseURL ? o[0] : o.length ? "/" + o.join("/") : "", null !== a && (c += "?" + a), null !== l && (c += "#" + l), c
  }, getOrigin = function () {
    var e = getInternalURLState(this), t = e.scheme, i = e.port;
    if ("blob" == t) try {
      return new URL(t.path[0]).origin
    } catch (e) {
      return "null"
    }
    return "file" != t && isSpecial(e) ? t + "://" + serializeHost(e.host) + (null !== i ? ":" + i : "") : "null"
    ...
    var e = getInternalURLState(this), t = e.host, i = e.port;
    return null === t ? "" : null === i ? serializeHost(t) : serializeHost(t) + ":" + i
    ...
    var e = getInternalURLState(this), t = e.path;
...
if (descriptors && objectDefineProperties(URLPrototype, {
  href: accessorDescriptor(serializeURL, (function (e) {
    var t = getInternalURLState(this), i = String(e), n = parseURL(t, i);
    if (n) throw TypeError(n);
    getInternalSearchParamsState(t.searchParams).updateSearchParams(t.query)
  })), origin: accessorDescriptor(getOrigin), protocol: accessorDescriptor(getProtocol, (function (e) {
    var t = getInternalURLState(this);
    parseURL(t, String(e) + ":", SCHEME_START)
  })), username: accessorDescriptor(getUsername, (function (e) {
    var t = getInternalURLState(this), i = arrayFrom(String(e));
    if (!cannotHaveUsernamePasswordPort(t)) {
      t.username = "";
      for (var n = 0; n < i.length; n++) t.username += percentEncode(i[n], userinfoPercentEncodeSet)
    }
  })), password: accessorDescriptor(getPassword, (function (e) {
    var t = getInternalURLState(this), i = arrayFrom(String(e));
    if (!cannotHaveUsernamePasswordPort(t)) {
      t.password = "";
      for (var n = 0; n < i.length; n++) t.password += percentEncode(i[n], userinfoPercentEncodeSet)
    }
  })), host: accessorDescriptor(getHost$1, (function (e) {
    var t = getInternalURLState(this);
  ...
  })), searchParams: accessorDescriptor(getSearchParams), hash: accessorDescriptor(getHash, (function (e) {
    var t = getInternalURLState(this);
...
}), {enumerable: !0}), redefine(URLPrototype, "toString", (function () {
  return serializeURL.call(this)
}), {enumerable: !0}), NativeURL) {
...
setToStringTag(URLConstructor, "URL"), _export({
  ...
  (function () {
    ...
    var s = function (e) {
      ...
      var t = typeof e;
      if ("undefined" === t) ; else if ("string" === t) "" !== e && this._fromString(e); else if (e instanceof s) {
        var i = this;
  ...
  if (function () {
    ...
    var t = e.URL, i = function (t, i) {
      ...
      var o = s.createElement("input");
      if (o.type = "url", o.value = t, ":" === r.protocol || !/:/.test(r.href) || !o.checkValidity() && !i) throw new TypeError("Invalid URL");
      Object.defineProperty(this, "_anchorElement", {value: r});
      var a = new e.URLSearchParams(this.search), l = !0, c = !0, u = this;
...
var RangeTouch = function () {
  ...
  return _createClass(e, [{
    ...
    key: "get", value: function (t) {
      ...
      var i, n = t.target, s = t.changedTouches[0], r = parseFloat(n.getAttribute("min")) || 0,
        o = parseFloat(n.getAttribute("max")) || 100, a = parseFloat(n.getAttribute("step")) || 1,
        l = n.getBoundingClientRect(), c = 100 / l.width * (this.config.thumbWidth / 2) / 100;
      return 0 > (i = 100 / l.width * (s.clientX - l.left)) ? i = 0 : 100 < i && (i = 100), 50 > i ? i -= (100 - 2 * i) * c : 50 < i && (i += 2 * (i - 50) * c), r + round(i / 100 * (o - r), a)
    }
  }, {
    ...
    key: "setup", value: function (t) {
      ...
      if (is$1.empty(t) || is$1.string(t) ? n = Array.from(document.querySelectorAll(is$1.string(t) ? t : 'input[type="range"]')) : is$1.element(t) ? n = [t] : is$1.nodeList(t) ? n = Array.from(t) : is$1.array(t) && (n = t.filter(is$1.element)), is$1.empty(n)) return null;
      var s = _objectSpread2({}, defaults$1, {}, i);
      if (is$1.string(t) && s.watch) {
        var r = new MutationObserver((function (i) {
          Array.from(i).forEach((function (i) {
            Array.from(i.addedNodes).forEach((function (i) {
              is$1.element(i) && matches$1(i, t) && new e(i, s)
            }))
          }))
        }));
...
const getConstructor = e => null != e ? e.constructor : null, instanceOf = (e, t) => Boolean(e && t && e instanceof t),
  isNullOrUndefined = e => null == e, isObject = e => getConstructor(e) === Object,
  isNumber = e => getConstructor(e) === Number && !Number.isNaN(e), isString = e => getConstructor(e) === String,
  isBoolean = e => getConstructor(e) === Boolean, isFunction = e => getConstructor(e) === Function,
  isArray = e => Array.isArray(e), isWeakMap = e => instanceOf(e, WeakMap), isNodeList = e => instanceOf(e, NodeList),
  isTextNode = e => getConstructor(e) === Text, isEvent = e => instanceOf(e, Event),
...
function extend(e = {}, ...t) {
  ...
  return is.object(i) ? (Object.keys(i).forEach((t => {
    is.object(i[t]) ? (Object.keys(e).includes(t) || Object.assign(e, {[t]: {}}), extend(e[t], i[t])) : Object.assign(e, {[t]: i[t]})
  })), extend(e, ...t)) : e
}
...
function wrap(e, t) {
  ...
  Array.from(i).reverse().forEach(((e, i) => {
    const n = i > 0 ? t.cloneNode(!0) : t, s = e.parentNode, r = e.nextSibling;
...
function createElement(e, t, i) {
  ...
  return is.object(t) && setAttributes(n, t), is.string(i) && (n.innerText = i), n
}
...
function insertElement(e, t, i, n) {
  is.element(t) && t.appendChild(createElement(e, i, n))
}
...
function getAttributesFromSelector(e, t) {
  ...
  return e.split(",").forEach((e => {
    const t = e.trim(), s = t.replace(".", ""), r = t.replace(/[[\]]/g, "").split("="), [o] = r,
      a = r.length > 1 ? r[1].replace(/["']/g, "") : "";
    switch (t.charAt(0)) {
      case".":
        is.string(n.class) ? i.class = `${n.class} ${s}` : i.class = s;
        break;
      case"#":
        i.id = t.replace("#", "");
        break;
...
function setFocus(e = null, t = !1) {
  is.element(e) && (e.focus({preventScroll: !0}), t && toggleClass(e, this.config.classNames.tabFocus))
}
...
const defaultCodecs = {
  ...
  check(e, t, i) {
    const n = browser.isIPhone && i && support.playsinline, s = support[e] || "html5" !== t;
...
function toggleListener(e, t, i, n = !1, s = !0, r = !1) {
  if (!e || !("addEventListener" in e) || is.empty(t) || !is.function(i)) return;
  const o = t.split(" ");
  let a = r;
  supportsPassiveListeners && (a = {passive: s, capture: r}), o.forEach((t => {
...
function on(e, t = "", i, n = !0, s = !1) {
  toggleListener.call(this, e, t, i, !0, n, s)
}

function off(e, t = "", i, n = !0, s = !1) {
  toggleListener.call(this, e, t, i, !1, n, s)
}

function once(e, t = "", i, n = !0, s = !1) {
  const r = (...o) => {
    off(e, t, r, n, s), i.apply(this, o)
  };
  toggleListener.call(this, e, t, r, !0, n, s)
}

function triggerEvent(e, t = "", i = !1, n = {}) {
...
function setAspectRatio(e) {
  ...
  const [n, s] = reduceAspectRatio(i), r = 100 / n * s;
  if (supportsCSS(`aspect-ratio: ${n}/${s}`) ? t.style.aspectRatio = `${n}/${s}` : t.style.paddingBottom = `${r}%`, this.isVimeo && !this.config.vimeo.premium && this.supported.ui) {
...
function roundAspectRatio(e, t, i = .05) {
  const n = e / t, s = closest(Object.keys(standardRatios), n);
  return Math.abs(s - n) <= i ? standardRatios[s] : [e, t]
}
        ...
        if (e.quality !== t) {
          if (e.config.quality.forced && is.function(e.config.quality.onChange)) e.config.quality.onChange(t); else {
            ...
            e.media.src = i.getAttribute("src"), ("none" !== r || o) && (e.once("loadedmetadata", (() => {
              e.speed = a, e.currentTime = n, s || silencePromise(e.play())
            })), e.media.load())
          }
...
function loadSprite(e, t) {
  ...
  const i = is.string(t);
  let n = !1;
  const s = () => null !== document.getElementById(t), r = (e, t) => {
    e.innerHTML = t, i && s() || document.body.insertAdjacentElement("afterbegin", e)
  };
  if (!i || !s()) {
    const s = Storage.supported, o = document.createElement("div");
    ...
    fetch(e).then((e => {
      is.empty(e) || (s && window.localStorage.setItem(`cache-${t}`, JSON.stringify({content: e})), r(o, e))
    })).catch((() => {
    }))
  }
}

const getHours = e => Math.trunc(e / 60 / 60 % 60, 10), getMinutes = e => Math.trunc(e / 60 % 60, 10),
...
const controls = {
  getIconUrl() {
    ...
    const i = "http://www.w3.org/2000/svg", n = controls.getIconUrl.call(this),
      s = `${n.cors ? "" : n.url}#${this.config.iconPrefix}`, r = document.createElementNS(i, "svg");
    setAttributes(r, extend(t, {"aria-hidden": "true", focusable: "false"}));
    const o = document.createElementNS(i, "use"), a = `${s}-${e}`;
    ...
    switch (["element", "icon", "label"].forEach((e => {
    ...
    })), "button" !== s.element || Object.keys(i).includes("type") || (i.type = "button"), Object.keys(i).includes("class") ? i.class.split(" ").some((e => e === this.config.classNames.control)) || extend(i, {class: `${i.class} ${this.config.classNames.control}`}) : i.class = this.config.classNames.control, e) {
      case"play":
      ...
      case"play-large":
        ...
        break;
      default:
        is.empty(s.label) && (s.label = n), is.empty(s.icon) && (s.icon = e)
    }
    const r = createElement(s.element);
    return s.toggle ? (r.appendChild(controls.createIcon.call(this, s.iconPressed, {class: "icon--pressed"})), r.appendChild(controls.createIcon.call(this, s.icon, {class: "icon--not-pressed"})), r.appendChild(controls.createLabel.call(this, s.labelPressed, {class: "label--pressed"})), r.appendChild(controls.createLabel.call(this, s.label, {class: "label--not-pressed"}))) : (r.appendChild(controls.createIcon.call(this, s.icon)), r.appendChild(controls.createLabel.call(this, s.label))), extend(i, getAttributesFromSelector(this.config.selectors.buttons[n], i)), setAttributes(r, i), "play" === n ? (is.array(this.elements.buttons[n]) || (this.elements.buttons[n] = []), this.elements.buttons[n].push(r)) : this.elements.buttons[n] = r, r
  }, createRange(e, t) {
    ...
    if ("volume" !== e) {
      ...
      const t = {played: "played", buffer: "buffered"}[e], n = t ? i18n.get(t, this.config) : "";
      i.innerText = `% ${n.toLowerCase()}`
    }
    return this.elements.display[e] = i, i
  }, createTime(e, t) {
    const i = getAttributesFromSelector(this.config.selectors.display[e], t), n = createElement("div", extend(i, {
    ...
    on.call(this, e, "keydown keyup", (i => {
      ...
      const n = matches(e, '[role="menuitemradio"]');
      if (!n && [32, 39].includes(i.which)) controls.showMenuPanel.call(this, t, !0); else {
        let t;
        32 !== i.which && (40 === i.which || n && 39 === i.which ? (t = e.nextElementSibling, is.element(t) || (t = e.parentNode.firstElementChild)) : (t = e.previousElementSibling, is.element(t) || (t = e.parentNode.lastElementChild)), setFocus.call(this, t, !0))
      }
    ...
    const o = getAttributesFromSelector(this.config.selectors.inputs[i]), a = createElement("button", extend(o, {
      type: "button",
      role: "menuitemradio",
    ...
    l.innerHTML = n, is.element(s) && l.appendChild(s), a.appendChild(l), Object.defineProperty(a, "checked", {
      enumerable: !0,
      get: () => "true" === a.getAttribute("aria-checked"),
      set(e) {
        e && Array.from(a.parentNode.children).filter((e => matches(e, '[role="menuitemradio"]'))).forEach((e => e.setAttribute("aria-checked", "false"))), a.setAttribute("aria-checked", e ? "true" : "false")
      }
    ...
    }), i, !1), controls.bindMenuItemShortcuts.call(this, a, i), t.appendChild(a)
  }, formatTime(e = 0, t = !1) {
    ...
    let t = 0;
    const i = (e, t) => {
      const i = is.number(t) ? t : 0, n = is.element(e) ? e : this.elements.display.buffer;
      if (is.element(n)) {
        n.value = i;
    ...
    if (is.element(t) && "range" === t.getAttribute("type")) {
      if (matches(t, this.config.selectors.inputs.seek)) {
        ...
        const e = controls.formatTime(this.currentTime), i = controls.formatTime(this.duration),
          n = i18n.get("seekLabel", this.config);
    ...
    if (is.event(e)) n = 100 / s.width * (e.pageX - s.left); else {
      if (!hasClass(this.elements.display.seekTooltip, t)) return;
      n = parseFloat(this.elements.display.seekTooltip.style.left, 10)
    }
    n < 0 ? n = 0 : n > 100 && (n = 100), controls.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * n), this.elements.display.seekTooltip.style.left = `${n}%`, is.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && i("mouseenter" === e.type)
  }, timeUpdate(e) {
    ...
    if ("captions" === e) s = this.currentTrack; else {
      if (s = is.empty(i) ? this[e] : i, is.empty(s) && (s = this.config[e].default), !is.empty(this.options[e]) && !this.options[e].includes(s)) return void this.debug.warn(`Unsupported value of '${s}' for ${e}`);
      if (!this.config[e].options.includes(s)) return void this.debug.warn(`Disabled value of '${s}' for ${e}`)
    }
    if (is.element(r) || (r = n && n.querySelector('[role="menu"]')), !is.element(r)) return;
    this.elements.settings.buttons[e].querySelector(`.${this.config.classNames.menu.value}`).innerHTML = controls.getLabel.call(this, e, s);
    ...
    const n = !is.empty(this.options.quality) && this.options.quality.length > 1;
    if (controls.toggleMenuButton.call(this, t, n), emptyElement(i), controls.checkMenu.call(this), !n) return;
    const s = e => {
    ...
    const e = "captions", t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
      i = captions.getTracks.call(this), n = Boolean(i.length);
    if (controls.toggleMenuButton.call(this, e, n), emptyElement(t), controls.checkMenu.call(this), !n) return;
    const s = i.map(((e, i) => ({
      value: i,
    ...
    s.unshift({
      ...
      list: t,
      type: "language"
    }), s.forEach(controls.createMenuItem.bind(this)), controls.updateSetting.call(this, e, t)
  }, setSpeedMenu() {
    ...
    controls.toggleMenuButton.call(this, e, i), emptyElement(t), controls.checkMenu.call(this), i && (this.options.speed.forEach((i => {
      controls.createMenuItem.call(this, {value: i, list: t, type: e, title: controls.getLabel.call(this, "speed", i)})
    ...
    const {hidden: n} = t;
    let s = n;
    if (is.boolean(e)) s = e; else if (is.keyboardEvent(e) && 27 === e.which) s = !1; else if (is.event(e)) {
      const n = is.function(e.composedPath) ? e.composedPath()[0] : e.target, r = t.contains(n);
      if (r || !r && e.target !== i && s) return
    }
    i.setAttribute("aria-expanded", s), toggleHidden(t, !s), toggleClass(this.elements.container, this.config.classNames.menu.open, s), s && is.keyboardEvent(e) ? controls.focusFirstMenuItem.call(this, null, !0) : s || n || setFocus.call(this, i, is.keyboardEvent(e))
  }, getMenuSize(e) {
    ...
    const n = i.parentNode, s = Array.from(n.children).find((e => !e.hidden));
    if (support.transitions && !support.reducedMotion) {
      n.style.width = `${s.scrollWidth}px`, n.style.height = `${s.scrollHeight}px`;
      const e = controls.getMenuSize.call(this, i), t = e => {
        e.target === n && ["width", "height"].includes(e.propertyName) && (n.style.width = "", n.style.height = "", off.call(this, n, transitionEndEvent, t))
      };
      on.call(this, n, transitionEndEvent, t), n.style.width = `${e.width}px`, n.style.height = `${e.height}px`
    }
    toggleHidden(s, !0), toggleHidden(i, !1), controls.focusFirstMenuItem.call(this, i, t)
  }, setDownloadUrl() {
    ...
    return dedupe(is.array(this.config.controls) ? this.config.controls : []).forEach((o => {
      if ("restart" === o && c.appendChild(i.call(this, "restart", u)), "rewind" === o && c.appendChild(i.call(this, "rewind", u)), "play" === o && c.appendChild(i.call(this, "play", u)), "fast-forward" === o && c.appendChild(i.call(this, "fast-forward", u)), "progress" === o) {
        const t = createElement("div", {class: `${u.class} plyr__progress__container`}),
        ...
        if (i.appendChild(s.call(this, "seek", {id: `plyr-seek-${e.id}`})), i.appendChild(n.call(this, "buffer")), this.config.tooltips.seek) {
          const e = createElement("span", {class: this.config.classNames.tooltip}, "00:00");
      ...
      if ("current-time" === o && c.appendChild(r.call(this, "currentTime", u)), "duration" === o && c.appendChild(r.call(this, "duration", u)), "mute" === o || "volume" === o) {
        ...
        if (is.element(t) && c.contains(t) || (t = createElement("div", extend({}, u, {class: `${u.class} plyr__volume`.trim()})), this.elements.volume = t, c.appendChild(t)), "mute" === o && t.appendChild(i.call(this, "mute")), "volume" === o && !browser.isIos) {
          const i = {max: 1, step: .05, value: this.config.volume};
          t.appendChild(s.call(this, "volume", extend(i, {id: `plyr-volume-${e.id}`})))
        }
      }
      if ("captions" === o && c.appendChild(i.call(this, "captions", u)), "settings" === o && !is.empty(this.config.settings)) {
        const n = createElement("div", extend({}, u, {class: `${u.class} plyr__menu`.trim(), hidden: ""}));
        n.appendChild(i.call(this, "settings", {
          "aria-haspopup": !0,
          "aria-controls": `plyr-settings-${e.id}`,
          "aria-expanded": !1
        }));
        const s = createElement("div", {class: "plyr__menu__container", id: `plyr-settings-${e.id}`, hidden: ""}),
          r = createElement("div"), o = createElement("div", {id: `plyr-settings-${e.id}-home`}),
        ...
        o.appendChild(a), r.appendChild(o), this.elements.settings.panels.home = o, this.config.settings.forEach((i => {
          const n = createElement("button", extend(getAttributesFromSelector(this.config.selectors.buttons.settings), {
            type: "button",
          ...
          t.call(this, n, i), on.call(this, n, "click", (() => {
            l.call(this, i, !1)
          }));
          const s = createElement("span", null, i18n.get(i, this.config)),
            o = createElement("span", {class: this.config.classNames.menu.value});
          o.innerHTML = e[i], s.appendChild(o), n.appendChild(s), a.appendChild(n);
          const c = createElement("div", {id: `plyr-settings-${e.id}-${i}`, hidden: ""}), u = createElement("button", {
            type: "button",
            class: `${this.config.classNames.control} ${this.config.classNames.control}--back`
          });
          u.appendChild(createElement("span", {"aria-hidden": !0}, i18n.get(i, this.config))), u.appendChild(createElement("span", {class: this.config.classNames.hidden}, i18n.get("menuBack", this.config))), on.call(this, c, "keydown", (e => {
            37 === e.which && (e.preventDefault(), e.stopPropagation(), l.call(this, "home", !0))
          }), !1), on.call(this, u, "click", (() => {
            l.call(this, "home", !1)
          })), c.appendChild(u), c.appendChild(createElement("div", {role: "menu"})), r.appendChild(c), this.elements.settings.buttons[i] = n, this.elements.settings.panels[i] = c
        })), s.appendChild(r), n.appendChild(s), c.appendChild(n), this.elements.settings.popup = s, this.elements.settings.menu = n
      }
      if ("pip" === o && support.pip && c.appendChild(i.call(this, "pip", u)), "airplay" === o && support.airplay && c.appendChild(i.call(this, "airplay", u)), "download" === o) {
        const e = extend({}, u, {element: "a", href: this.download, target: "_blank"});
    ...
    })), this.isHTML5 && o.call(this, html5.getQualityOptions.call(this)), a.call(this), c
  }, inject() {
    ...
    })(e)), is.string(this.config.selectors.controls.container) && (n = document.querySelector(this.config.selectors.controls.container)), is.element(n) || (n = this.elements.container);
    if (n[is.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e), is.element(this.elements.controls) || controls.findElements.call(this), !is.empty(this.elements.buttons)) {
      const e = e => {
        const t = this.config.classNames.controlPressed;
        Object.defineProperty(e, "pressed", {
          enumerable: !0, get: () => hasClass(e, t), set(i = !1) {
            toggleClass(e, t, i)
          }
        })
      };
    ...
    if (browser.isEdge && repaint(n), this.config.tooltips.controls) {
      const {classNames: e, selectors: t} = this.config, i = `${t.controls.wrapper} ${t.labels} .${e.hidden}`,
        n = getElements.call(this, i);
...
const captions = {
    setup() {
      ...
      const e = captions.getTracks.call(this, !0), {active: t, language: i, meta: n, currentTrackNode: s} = this.captions,
        r = Boolean(e.find((e => e.language === i)));
      this.isHTML5 && this.isVideo && e.filter((e => !n.get(e))).forEach((e => {
        this.debug.log("Track added", e), n.set(e, {default: "showing" === e.mode}), "showing" === e.mode && (e.mode = "hidden"), on.call(this, e, "cuechange", (() => captions.updateCues.call(this)))
      })), (r && this.language !== i || !e.includes(s)) && (captions.setLanguage.call(this, i), captions.toggle.call(this, t && r)), toggleClass(this.elements.container, this.config.classNames.captions.enabled, !is.empty(e)), is.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && controls.setCaptionsMenu.call(this)
    }, toggle(e, t = !0) {
      if (!this.supported.ui) return;
      const {toggled: i} = this.captions, n = this.config.classNames.captions.active, s = is.nullOrUndefined(e) ? !i : e;
      if (s !== i) {
      ...
      if (-1 !== e) if (is.number(e)) if (e in i) {
        if (this.captions.currentTrack !== e) {
          ...
          this.captions.currentTrackNode = n, controls.updateSetting.call(this, "captions"), t || (this.captions.language = s, this.storage.set({language: s})), this.isVimeo && this.embed.enableTextTrack(s), triggerEvent.call(this, this.media, "languagechange")
        }
        captions.toggle.call(this, !0, t), this.isHTML5 && this.isVideo && captions.updateCues.call(this)
      } else this.debug.warn("Track not found", e); else this.debug.warn("Invalid caption argument", e); else captions.toggle.call(this, !1, t)
    }, setLanguage(e, t = !0) {
      if (!is.string(e)) return void this.debug.warn("Invalid language argument", e);
      const i = e.toLowerCase();
      this.captions.language = i;
      const n = captions.getTracks.call(this), s = captions.findTrack.call(this, [i]);
      ...
      const i = captions.getTracks.call(this), n = e => Number((this.captions.meta.get(e) || {}).default),
  ...
  providers = {html5: "html5", youtube: "youtube", vimeo: "vimeo"}, types = {audio: "audio", video: "video"};
  ...
  constructor(e) {
    _defineProperty$1(this, "onChange", (() => {
      ...
      if (e ? this.scrollPosition = {
        ...
        const n = is.string(t.content) && t.content.includes(i);
      ...
      const t = document.activeElement,
        i = getElements.call(this.player, "a[href], button:not(:disabled), input:not(:disabled), [tabindex]"), [n] = i,
        s = i[i.length - 1];
      ...
      this.enabled && (browser.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !Fullscreen.native || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? is.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({navigationUI: "hide"}))
...
const ui = {
  addStyleHook() {
    ...
    }), 0), ui.setTitle.call(this), this.poster && ui.setPoster.call(this, this.poster, !1).catch((() => {
    ...
    toggleClass(this.elements.container, this.config.classNames.playing, this.playing), toggleClass(this.elements.container, this.config.classNames.paused, this.paused), toggleClass(this.elements.container, this.config.classNames.stopped, this.stopped), Array.from(this.elements.buttons.play || []).forEach((e => {
      Object.assign(e, {pressed: this.playing}), e.setAttribute("aria-label", i18n.get(this.playing ? "pause" : "play", this.config))
...
class Listeners {
  constructor(e) {
    _defineProperty$1(this, "firstTouch", (() => {
      ...
      !t.keyboard.global && t.keyboard.focused && on.call(e, i.container, "keydown keyup", this.handleKey, !1), on.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t => {
        ...
        let r = 0;
        ["touchstart", "touchmove", "mousemove"].includes(t.type) && (ui.toggleControls.call(e, !0), r = e.touch ? 3e3 : 2e3), clearTimeout(n.controls), n.controls = setTimeout((() => ui.toggleControls.call(e, !1)), r)
      }));
      const s = () => {
        if (!e.isVimeo || e.config.vimeo.premium) return;
        const t = i.wrapper, {active: n} = e.fullscreen, [s, r] = getAspectRatio.call(e),
          o = supportsCSS(`aspect-ratio: ${s} / ${r}`);
        if (!n) return void (o ? (t.style.width = null, t.style.height = null) : (t.style.maxWidth = null, t.style.margin = null));
        const [a, l] = getViewportSize(), c = a / l > s / r;
      ...
      e.supported.ui && e.config.disableContextMenu && on.call(e, t.wrapper, "contextmenu", (e => {
        ...
        controls.updateSetting.call(e, "speed"), e.storage.set({speed: e.speed})
      ...
      on.call(e, e.media, i, (i => {
        let {detail: n = {}} = i;
        "error" === i.type && (n = e.media.error), triggerEvent.call(e, t.container, i.type, !0, n)
      }))
    })), _defineProperty$1(this, "proxy", ((e, t, i) => {
      const {player: n} = this, s = n.config.listeners[i];
      let r = !0;
      is.function(s) && (r = s.call(n, e)), !1 !== r && is.function(t) && t.call(n, e)
    })), _defineProperty$1(this, "bind", ((e, t, i, n, s = !0) => {
      const {player: r} = this, o = r.config.listeners[n], a = is.function(o);
      on.call(r, e, t, (e => this.proxy(e, i, n)), s && !a)
      ...
      if (t.buttons.play && Array.from(t.buttons.play).forEach((t => {
        ...
        const i = t.progress.getBoundingClientRect(), n = 100 / i.width * (e.pageX - i.left);
        e.currentTarget.setAttribute("seek-value", n)
      })), this.bind(t.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (t => {
        const i = t.currentTarget, n = t.keyCode ? t.keyCode : t.which, s = "play-on-seeked";
        if (is.keyboardEvent(t) && 39 !== n && 37 !== n) return;
        e.lastSeekTime = Date.now();
        const r = i.hasAttribute(s), o = ["mouseup", "touchend", "keyup"].includes(t.type);
        r && o ? (i.removeAttribute(s), silencePromise(e.play())) : !o && e.playing && (i.setAttribute(s, ""), e.pause())
      })), browser.isIos) {
      ...
      this.bind(t.inputs.seek, i, (t => {
        ...
        is.empty(n) && (n = i.value), i.removeAttribute("seek-value"), e.currentTime = n / i.max * e.duration
        ...
        clearTimeout(n.controls), n.controls = setTimeout((() => ui.toggleControls.call(e, !1)), s)
      })), this.bind(t.inputs.volume, "wheel", (t => {
        const i = t.webkitDirectionInvertedFromDevice, [n, s] = [t.deltaX, -t.deltaY].map((e => i ? -e : e)),
  ...
  handleKey(e) {
    const {player: t} = this, {elements: i} = t, n = e.keyCode ? e.keyCode : e.which, s = "keydown" === e.type,
      r = s && n === this.lastKey;
    ...
    if (s) {
      ...
      if (is.element(s)) {
        const {editable: n} = t.config.selectors, {seek: r} = i.inputs;
        if (s !== r && matches(s, n)) return;
        if (32 === e.which && matches(s, 'button, [role^="menuitem"]')) return
      }
...
var loadjs_umd = createCommonjsModule((function (e, t) {
  e.exports = function () {
    ...
    function a(t, i, n, s) {
      var r, o, l = document, c = n.async, u = (n.numRetries || 0) + 1, h = n.before || e,
    ...
    function l(e, t, i) {
      var n, s, r = (e = e.push ? e : [e]).length, o = r, l = [];
    ...
    function c(e, i, n) {
      ...
      function c(t, i) {
        l(e, (function (e) {
          o(a, e), t && o({success: t, error: i}, e), r(s, e)
        }), a)
      }
...
const vimeo = {
  setup() {
    ...
    is.empty(o) && (o = e.media.getAttribute(e.config.attributes.embed.id));
    const a = parseId$1(o), l = createElement("iframe"), c = format(e.config.urls.vimeo.iframe, a, r);
    if (l.setAttribute("src", c), l.setAttribute("allowfullscreen", ""), l.setAttribute("allow", ["autoplay", "fullscreen", "picture-in-picture", "encrypted-media", "accelerometer", "gyroscope"].join("; ")), is.empty(n) || l.setAttribute("referrerPolicy", n), i || !t.customControls) l.setAttribute("data-poster", e.poster), e.media = replaceElement(l, e.media); else {
      const t = createElement("div", {class: e.config.classNames.embedContainer, "data-poster": e.poster});
    ...
    Object.defineProperty(e.media, "currentTime", {
      get: () => u, set(t) {
        const {embed: i, media: n, paused: s, volume: r} = e, o = s && !i.hasPlayed;
        n.seeking = !0, triggerEvent.call(e, n, "seeking"), Promise.resolve(o && i.setVolume(0)).then((() => i.setCurrentTime(t))).then((() => o && i.pause())).then((() => o && i.setVolume(r))).catch((() => {
        }))
      }
    });
    ...
    Object.defineProperty(e.media, "playbackRate", {
      get: () => h, set(t) {
        e.embed.setPlaybackRate(t).then((() => {
          h = t, triggerEvent.call(e, e.media, "ratechange")
        })).catch((() => {
          e.options.speed = [1]
        }))
      }
    ...
    Object.defineProperty(e.media, "volume", {
      get: () => d, set(t) {
        e.embed.setVolume(t).then((() => {
          d = t, triggerEvent.call(e, e.media, "volumechange")
        }))
      }
    });
    ...
    Object.defineProperty(e.media, "muted", {
      get: () => p, set(t) {
        ...
        e.embed.setVolume(i ? 0 : e.config.volume).then((() => {
          p = i, triggerEvent.call(e, e.media, "volumechange")
        }))
      }
    });
    ...
    Object.defineProperty(e.media, "loop", {
      ...
      m = t, controls.setDownloadUrl.call(e)
    })).catch((e => {
      this.debug.warn(e)
    })), Object.defineProperty(e.media, "currentSrc", {get: () => m}), Object.defineProperty(e.media, "ended", {get: () => e.currentTime === e.duration}), Promise.all([e.embed.getVideoWidth(), e.embed.getVideoHeight()]).then((t => {
      const [i, n] = t;
      e.embed.ratio = roundAspectRatio(i, n), setAspectRatio.call(this)
  ...
  setup() {
    ...
    fetch(format(this.config.urls.youtube.api, e)).then((e => {
      if (is.object(e)) {
        ...
        this.config.title = t, ui.setTitle.call(this), this.embed.ratio = roundAspectRatio(n, i)
      }
    ...
    is.empty(n) && (n = e.media.getAttribute(this.config.attributes.embed.id));
    const s = parseId(n),
      r = createElement("div", {id: generateId(e.provider), "data-poster": t.customControls ? e.poster : void 0});
      ...
      events: {
        onError(t) {
          if (!e.media.error) {
            ...
            e.media.error = {code: i, message: n}, triggerEvent.call(e, e.media, "error")
          }
          ...
          const n = i.target;
          youtube.getTitle.call(e, s), e.media.play = () => {
            assurePlaybackState.call(e, !0), n.playVideo()
          }, e.media.pause = () => {
            assurePlaybackState.call(e, !1), n.pauseVideo()
          }, e.media.stop = () => {
            n.stopVideo()
          ...
          Object.defineProperty(e.media, "volume", {
            get: () => r, set(t) {
              r = t, n.setVolume(100 * r), triggerEvent.call(e, e.media, "volumechange")
            }
          });
          let {muted: o} = e.config;
          Object.defineProperty(e.media, "muted", {
            get: () => o, set(t) {
              const i = is.boolean(t) ? t : o;
              o = i, n[i ? "mute" : "unMute"](), n.setVolume(100 * r), triggerEvent.call(e, e.media, "volumechange")
            }
          ...
          e.options.speed = a.filter((t => e.config.speed.options.includes(t))), e.supported.ui && t.customControls && e.media.setAttribute("tabindex", -1), triggerEvent.call(e, e.media, "timeupdate"), triggerEvent.call(e, e.media, "durationchange"), clearInterval(e.timers.buffering), e.timers.buffering = setInterval((() => {
          ...
          switch (e.media.seeking && [1, 2].includes(i.data) && (e.media.seeking = !1, triggerEvent.call(e, e.media, "seeked")), i.data) {
            case-1:
              ...
              break;
            case 0:
              assurePlaybackState.call(e, !1), e.media.loop ? (n.stopVideo(), n.playVideo()) : triggerEvent.call(e, e.media, "ended");
              break;
            case 1:
              ...
              }), 50), e.media.duration !== n.getDuration() && (e.media.duration = n.getDuration(), triggerEvent.call(e, e.media, "durationchange")));
              break;
            case 2:
          ...
          triggerEvent.call(e, e.elements.container, "statechange", !1, {code: i.data})
        }
      }
    })
  }
  ...
  constructor(e) {
    _defineProperty$1(this, "load", (() => {
        ...
        if (0 !== e && -1 !== e && e < this.player.duration) {
          ...
          if (is.element(t)) {
            const i = 100 / this.player.duration * e,
              n = createElement("span", {class: this.player.config.classNames.cues});
      ...
      this.player.on("canplay", (() => {
        ...
        is.empty(this.cuePoints) || this.cuePoints.forEach(((i, n) => {
...
class PreviewThumbnails {
  constructor(e) {
    _defineProperty$1(this, "load", (() => {
      ...
      fetch(e).then((i => {
        const n = {frames: parseVtt(i), height: null, urlPrefix: ""};
      ...
      if (this.loaded && is.event(e) && ["touchmove", "mousemove"].includes(e.type) && this.player.media.duration) {
        if ("touchmove" === e.type) this.seekTime = this.player.media.duration * (this.player.elements.inputs.seek.value / 100); else {
          const t = this.player.elements.progress.getBoundingClientRect(), i = 100 / t.width * (e.pageX - t.left);
      ...
      const e = createElement("div", {class: this.player.config.classNames.previewThumbnails.timeContainer});
      this.elements.thumb.time = createElement("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.container.appendChild(e), is.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = createElement("div", {class: this.player.config.classNames.previewThumbnails.scrubbingContainer}), this.player.elements.wrapper.appendChild(this.elements.scrubbing.container)
      ...
      const t = this.showingThumb, i = this.thumbnails[e], {urlPrefix: n} = i, s = i.frames[t], r = i.frames[t].text,
        o = n + r;
      if (this.currentImageElement && this.currentImageElement.dataset.filename === r) this.showImage(this.currentImageElement, s, e, t, r, !1), this.currentImageElement.dataset.index = t, this.removeOldImages(this.currentImageElement); else {
    ...
    })), _defineProperty$1(this, "showImage", ((e, t, i, n, s, r = !0) => {
    ...
    })))), _defineProperty$1(this, "getHigherQuality", ((e, t, i, n) => {
      ...
      const e = this.player.elements.progress.getBoundingClientRect(),
        ...
        n = t.left - e.left + 10, s = t.right - e.left - i.clientWidth - 10;
...
const source = {
  insertElements(e, t) {
    is.string(t) ? insertElement(e, this.media, {src: t}) : is.array(t) && t.forEach((t => {
    ...
    getDeep(e, "sources.length") ? (html5.cancelRequests.call(this), this.destroy.call(this, (() => {
      ...
      const {sources: t, type: i} = e, [{provider: n = providers.html5, src: s}] = t, r = "html5" === n ? i : "div",
        o = "html5" === n ? {} : {src: s};
      Object.assign(this, {
        provider: n,
        type: i,
        supported: support.check(i, n, this.config.playsinline),
        media: createElement(r, o)
...
class Plyr {
  constructor(e, t) {
    if (_defineProperty$1(this, "play", (() => is.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((() => this.ads.play())).catch((() => silencePromise(this.media.play()))), this.media.play()) : null)), _defineProperty$1(this, "pause", (() => this.playing && is.function(this.media.pause) ? this.media.pause() : null)), _defineProperty$1(this, "togglePlay", (e => (is.boolean(e) ? e : !this.playing) ? this.play() : this.pause())), _defineProperty$1(this, "stop", (() => {
      ...
      if (this.supported.ui && !this.isAudio) {
        ...
        if (n && is.array(this.config.controls) && this.config.controls.includes("settings") && !is.empty(this.config.settings) && controls.toggleMenu.call(this, !1), n !== t) {
    ...
    switch (n) {
      case"div":
        if (s = this.media.querySelector("iframe"), is.element(s)) {
          if (r = parseUrl(s.getAttribute("src")), this.provider = getProviderByUrl(r.toString()), this.elements.container = this.media, this.media = s, this.elements.container.className = "", r.search.length) {
            const e = ["1", "true"];
      ...
      case"video":
      case"audio":
        this.type = n, this.provider = providers.html5, this.media.hasAttribute("crossorigin") && (this.config.crossorigin = !0), this.media.hasAttribute("autoplay") && (this.config.autoplay = !0), (this.media.hasAttribute("playsinline") || this.media.hasAttribute("webkit-playsinline")) && (this.config.playsinline = !0), this.media.hasAttribute("muted") && (this.config.muted = !0), this.media.hasAttribute("loop") && (this.config.loop.active = !0);
        break;
      default:
        return void this.debug.error("Setup failed: unsupported type")
    }
    this.supported = support.check(this.type, this.provider, this.config.playsinline), this.supported.api ? (this.eventListeners = [], this.listeners = new Listeners(this), this.storage = new Storage(this), this.media.plyr = this, is.element(this.elements.container) || (this.elements.container = createElement("div", {tabindex: 0}), wrap(this.media, this.elements.container)), ui.migrateStyles.call(this), ui.addStyleHook.call(this), media.setup.call(this), this.config.debug && on.call(this, this.elements.container, this.config.events.join(" "), (e => {
  ...
  set speed(e) {
    ...
    t = clamp(t, i, n), this.config.speed.selected = t, setTimeout((() => {
  ...
  set quality(e) {
    ...
    if (!i.length) return;
    let n = [!is.empty(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(is.number), s = !0;
    if (!i.includes(n)) {
      const e = closest(i, n);
  ...
  set poster(e) {
    this.isVideo ? ui.setPoster.call(this, e, !1).catch((() => {
